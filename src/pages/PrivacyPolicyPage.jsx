...
import { getDefaultPrivacyPolicy } from '@/lib/legalDefaults.js';
...
const PrivacyPolicyPage = () => {
  ...
  const content = (siteSettings?.privacy_policy || '').trim() || getDefaultPrivacyPolicy(contactEmail);
  ...
  return (
    <>
      <Helmet>
        <title>Privacy Policy - {siteSettings?.site_name || 'Giver Recording Studio'}</title>
      </Helmet>
